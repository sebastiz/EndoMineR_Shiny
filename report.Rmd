...
```{r figsBarrettsHistopath, echo=FALSE, warning=FALSE,fig.width=7,fig.height=4,fig.align="center",fig.cap="Performance associated with your Barrett's endoscopies"}
...
#   `r ifelse(exists("ExpectedNumber$MeanDiff"),paste0("On average you took",text_spec(ExpectedNumber$MeanDiff, color = "red"),"biopsies versus the expected number of biopsies you should have taken for your Barrett's cases."),"")`
